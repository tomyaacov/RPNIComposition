...
#SBATCH --job-name ttt_rpni_ga3 ### name of the job. replace my_job with your desired job name
#SBATCH --output ttt_rpni_ga3.out ### output log for running job - %J is the job number variable
